...
class PolicyGradientAgent(Agent):
    ...
    def process_experience(self, belief, action, action_prob, next_belief, reward, done):
    ...
    def train(self, beliefs, actions, action_probs, next_beliefs, rewards, dones):
        ...
        actor_loss, critic_loss = self.compute_loss(beliefs, actions, action_probs, next_beliefs, rewards, dones)
